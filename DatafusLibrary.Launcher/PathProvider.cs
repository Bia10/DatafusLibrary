...
public class PathProvider : FrostingContext
{
    ...
    public PathProvider(ICakeContext context) : base(context)
    {
        ...
        DatafusReleaseDownloadPath = LoadTempPath() + "datafusRelease";
    ...
    private void LoadTestProjectOutputPath()
    {
        var testProjectOutputPath = _testProjectPath.FullPath
            .Replace(_testProjectPath.Segments.Last(), DebugOutputPathSegment)
            .Replace("//", "/")
            .Replace(@"\\", @"\");
    ...
    {
        var testProjectAssemblyPath = _testProjectPath.FullPath
            .Replace(_testProjectPath.Segments.Last(),
